...
const AI_MODELS = [
    ...
    },
    {
        ...
        provider: 'Minimax',
        description: 'High-quality Chinese AI model with excellent motion',
        price: 11,
        features: ['Strong motion', 'Cultural accuracy', 'High fidelity'],
        status: 'live',
        bestFor: 'Character animation, Asian market content',
    },
    {
        id: 'runway-gen2',
        name: 'Runway Gen 2',
        ...
        price: 7,
        features: ['Reliable', 'Established', 'Good quality'],
        status: 'live',
        bestFor: 'Standard projects, proven workflows',
    },
    {
        id: 'pika-15',
        name: 'Pika 1.5',
        provider: 'Pika Labs',
        description: 'Earlier version with consistent results',
        price: 6,
        features: ['Consistent', 'Budget-friendly', 'Fast'],
        status: 'live',
        bestFor: 'High-volume projects, testing',
    },
    {
        id: 'luma-ray2',
        name: 'Luma Ray 2',
        provider: 'Luma Labs',
        description: 'Advanced lighting and ray tracing capabilities',
        price: 10,
        features: ['Ray tracing', 'Advanced lighting', 'Photorealistic'],
        status: 'live',
        bestFor: 'Product visualization, architectural renders',
    },
    {
        id: 'kling-ai-15',
        name: 'Kling 1.5',
        provider: 'Kling AI',
        description: 'Earlier version with solid performance',
        price: 8,
        features: ['Solid performance', 'Reliable', 'Cost-effective'],
        status: 'live',
        bestFor: 'Standard animations, consistent output',
    },
    {
        id: 'stable-video',
        name: 'Stable Video Diffusion',
        provider: 'Stability AI',
        description: 'Open-source model with good customization',
        price: 7,
    ...
    },
    {
        ...
        name: 'Veo 2',
        provider: 'Google',
        description: 'Previous generation Veo with proven results',
        price: 10,
        features: ['Proven track record', 'Reliable', 'Good quality'],
        status: 'live',
        bestFor: 'Established workflows, consistent results',
    },
    {
        id: 'sora-1',
        name: 'Sora 1',
        provider: 'OpenAI',
        description: 'First generation Sora, still powerful',
        price: 12,
        features: ['High quality', 'Established', 'Proven'],
        status: 'live',
        bestFor: 'Premium projects, reliable output',
    },
    {
        id: 'haiper-2',
        name: 'Haiper 2.0',
        provider: 'Haiper',
        description: 'Fast generation with good quality-to-speed ratio',
        price: 8,
        features: ['Fast', 'Efficient', 'Good quality'],
        status: 'live',
        bestFor: 'Quick iterations, rapid prototyping',
    },
];
